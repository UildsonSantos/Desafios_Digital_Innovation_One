...
public class Participante {
    ...
    public Participante(String nome, Integer valorDaFicha) {
        this.nome = nome;
    ...
    public static void main(String[] args) {
        ...
        List<Participante> listaDeAlunos = new ArrayList<>();
        ...
        while (numeroDeAlunos > 0) {
            ...
            for (int i = 0; i < numeroDeAlunos; i++) {
                ...
                listaDeAlunos.add(new Participante(aluno, valorFicha));
            }
